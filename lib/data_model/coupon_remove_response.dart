...
CouponRemoveResponse couponRemoveResponseFromJson(String str) =>
    CouponRemoveResponse.fromJson(json.decode(str));

String couponRemoveResponseToJson(CouponRemoveResponse data) =>
